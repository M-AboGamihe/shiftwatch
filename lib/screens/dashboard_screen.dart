...
import '../features/employee_details/presentation/dashboard/dashboard_details_event.dart';
import '../features/employee_details/presentation/dashboard/dashboard_details_state.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  late final DashboardDetailsBloc _bloc;
  late String empName;
  ...
  void initState() {
    super.initState();
    _bloc = ServiceLocator.createDashboardDetailsBloc();
  }
  ...
  void didChangeDependencies() {
    ...
    _bloc.add(LoadDashboardDetailsEvent(username: username, employeeName: empName));
    _initialized = true;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: _bloc,
      child: BlocConsumer<DashboardDetailsBloc, DashboardDetailsState>(
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildMonthsBar(Map<String, dynamic>.from(empData['month'] ?? {})),
                            const SizedBox(height: 5),
                            ...
                            const SizedBox(height: 5),
                            _buildDaysBar(Map<String, dynamic>.from(empData['month'] ?? {})),
                            const SizedBox(height: 5),
                            selectedDay != null
